...
- **Готовые примеры скриптов**: 6 предустановленных скриптов для администрирования (system info, security audit, disk cleanup, updates, services, network)
...
- **Динамические настройки**: Изменение параметров мониторинга без перезапуска
